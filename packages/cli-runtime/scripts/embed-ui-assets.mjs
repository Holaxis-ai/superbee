...
// `pako` (packages/cli-runtime devDependency) — NOT `node:zlib`, whose DEFLATE output varies across zlib
...
// packages/cli-runtime/scripts -> packages/cli-runtime
const cliRoot = resolve(here, "..");
// packages/cli-runtime -> repo root
...
export function embedUiAssets() {
  ...
  if (totalGzipBytes > UI_ASSET_BUDGET_BYTES) {
    console.error(
      `ui asset budget exceeded: ${totalGzipBytes} bytes gzipped > ${UI_ASSET_BUDGET_BYTES} byte budget (packages/cli-runtime/scripts/embed-ui-assets.mjs)`,
    );
    process.exit(1);
  }
  ...
  const body = entries
    ...
    .join("\n");
  const source = `// AUTO-GENERATED by packages/cli-runtime/scripts/embed-ui-assets.mjs — DO NOT EDIT BY HAND.
//
