...
test("path identity folds separators, and case only where the platform is case-insensitive", async () => {
  ...
  const posix = "/repo/packages/cli-runtime/src/command-text.ts";
  const windows = "\\repo\\packages\\cli-runtime\\src\\command-text.ts";
  ...
  assert.notEqual(
    canonicalPath("/repo/packages/cli-runtime/src/command-text.ts"),
    canonicalPath("/repo/packages/cli-runtime/test/fixtures/nested/command-text.ts"),
  );
