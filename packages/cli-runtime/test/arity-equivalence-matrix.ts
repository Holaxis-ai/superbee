...
export const BEHAVIOR_ASSIGNMENTS = [
  ...
  ordinary("docFieldSet", 2, { arityKind: "bounded" }),
  ordinary("docFieldAdd", 2, { arityKind: "bounded" }),
  ordinary("docFieldRemove", 2, { arityKind: "bounded" }),
  ordinary("docFieldEdit", 2),
  ordinary("docFieldReplaceAll", 2),
