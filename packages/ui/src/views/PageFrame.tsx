        ...
        <div className="action-confirmation-backdrop" role="presentation">
          <section className="action-confirmation" role="dialog" aria-modal="true" aria-labelledby="action-confirmation-title">
            ...
            <dl>
              ...
              <div><dt>Before</dt><dd>{["body", "document"].includes(confirmation.field) ? <pre className="action-body-preview">{String(confirmation.before ?? "")}</pre> : <code>{scalarLabel(confirmation.before)}</code>}</dd></div>
              <div><dt>After</dt><dd>{["body", "document"].includes(confirmation.field) ? <pre className="action-body-preview">{String(confirmation.after)}</pre> : <code>{scalarLabel(confirmation.after)}</code>}</dd></div>
