...
const HOME_BASELINE_TOON = [
  ...
  '  "Documents & links": "doc write, doc update, doc field, doc verify, doc read, doc open, doc history, doc delete, list, link"',
  ...
  '  Session: "version, session-start, turn-end, hook install|status|uninstall, skill install|status|uninstall, setup"',
  '  Hosted: "login, whoami, logout, checkout, export, publish"',
