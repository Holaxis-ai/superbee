...
function run(
  ...
  // Invoke the JS entry directly to preserve argv while keeping the managed symlink on PATH.
  // The child still proves cliInvocation() resolves the bare `superbee` name.
