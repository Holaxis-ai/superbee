...
// command records the CURRENT run's tokenized URL using the same platform-native private-state
// discipline as credentials. Combined with the stable per-bundle PORT, a human whose tab
