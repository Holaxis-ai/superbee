  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        usage: "ui [--dir <path> | --remote <url>] [--port <p>] [--open] | ui --status [--dir <path>] [--limit <n>] | ui --stop [--dir <path>] [--actor <name>] [--abandon]",
        summary:
