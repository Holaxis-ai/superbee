  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        summary: "Install this package's Agent Skill (SKILL.md + references/) into Claude Code and Codex skill folders; OpenCode discovers the managed Claude-compatible copy, while its SessionStart integration remains `hook install`; manifest-tracked, idempotent, refuses folders it does not manage",
      },
      {
        id: "setup",
        leaves: [
