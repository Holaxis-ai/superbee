  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        summary:
          "Show a doc's version history (newest first, capped at 20 by default — --limit 0 for all; a history-keeping backend returns the full attributed chain, a local bundle just the current revision; a hosted checkout reads the host's chain, and --seq <n> prints one version's content there) — the tokens for --expected-version",
      },
      {
        id: "docDelete",
