...
function referenceNotesAddendum(invocation: string, ref: RefPointer): string[] {
  return [
    ...
    `- Exact-target engineering review: \`${ref.path("recipes/engineering-review/")}\` installs the`,
    ...
    `  parent-red/head-green proofs. Install it by NAME — \`${invocation} recipe add engineering-review\``,
